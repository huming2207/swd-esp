...
void DAP_SPI_Init()
{
    ...
    DAP_SPI.clock.clk_equ_sysclk = false;
    DAP_SPI.clock.clkdiv_pre = 0;
    DAP_SPI.clock.clkcnt_n = SPI_10MHz_DIV - 1;
    DAP_SPI.clock.clkcnt_h = SPI_10MHz_DIV / 2 - 1;
    DAP_SPI.clock.clkcnt_l = SPI_10MHz_DIV - 1;
...
#elif defined CONFIG_IDF_TARGET_ESP32S3
inline __attribute__((always_inline)) void DAP_SPI_Deinit()
{
